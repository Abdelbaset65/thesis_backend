...
from thesis_app.views import ProfileDetails, PatientList, PatientDetails, ScanList, ScanDetails, ScanViewSet, ProfilePatients, PatientScans
...
urlpatterns = [
    ...
    path("profile/patients", ProfilePatients.as_view()),
